...
int main(void) {
    ...
    osThreadStaticDef(defaultTask, StartDefaultTask,
                      osPriorityNormal, 0, 2048, defaultTaskBuffer,
...
static void MX_TIM8_Init(void) {
    ...
    if (HAL_TIMEx_ConfigBreakDeadTime(&htim8,
...
static void MX_GPIO_Init(void) {
    ...
    HAL_GPIO_WritePin(GPIOE,
                      DISP_IO2_Pin | DISP_IO3_Pin | DISP_IO4_Pin | DISP_IO5_Pin
                      | DISP_IO6_Pin | DISP_IO7_Pin | DISP_IO8_Pin | DISP_IO9_Pin
                      | DISP_IO10_Pin | DISP_IO11_Pin | DISP_IO12_Pin |
                      DISP_IO13_Pin
                      | DISP_IO14_Pin | DISP_IO15_Pin | DISP_IO0_Pin |
                      DISP_IO1_Pin, GPIO_PIN_RESET);
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOC,
                      DISP_RS_Pin | DISP_WR_Pin | DISP_RD_Pin, GPIO_PIN_RESET);
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(TOUCH_CS_GPIO_Port, TOUCH_CS_Pin,
                      GPIO_PIN_SET);
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOA, DISP_CS_Pin | SD_CS_Pin,
                      GPIO_PIN_SET);
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOA, DISP_RST_Pin | USB_IDENT_Pin,
                      GPIO_PIN_RESET);
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(AD5941_CS_GPIO_Port, AD5941_CS_Pin,
                      GPIO_PIN_SET);
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(AD5941_RESET_GPIO_Port, AD5941_RESET_Pin,
                      GPIO_PIN_RESET);
    ...
    GPIO_InitStruct.Pin = DISP_IO2_Pin | DISP_IO3_Pin |
                          DISP_IO4_Pin | DISP_IO5_Pin
                          | DISP_IO6_Pin | DISP_IO7_Pin | DISP_IO8_Pin | DISP_IO9_Pin
                          | DISP_IO10_Pin | DISP_IO11_Pin | DISP_IO12_Pin |
                          DISP_IO13_Pin
                          | DISP_IO14_Pin | DISP_IO15_Pin | DISP_IO0_Pin |
    ...
    GPIO_InitStruct.Pin = DISP_RS_Pin | DISP_WR_Pin |
                          DISP_RD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
