...
class MenuValue: public MenuEntry {
  public:
    MenuValue(const char* name, T* value,
  ...
  private:
    ...
    void draw(coords_t offset) override {
        ...
        display_AutoCenterString(s, COORDS(offset.x,
                                           offset.y + size.y / 2),
...
template <> void MenuValue<float>::CreateUnitString(char* s,
        uint8_t len);
