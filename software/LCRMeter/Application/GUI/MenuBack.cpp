...
void MenuBack::draw(coords_t offset) {
    ...
    display_HorizontalLine(arrowStart.x, arrowStart.y,
                           arrowLength);
    display_HorizontalLine(arrowStart.x, arrowStart.y + 1,
                           arrowLength);
    display_Line(arrowStart.x, arrowStart.y,
                 arrowStart.x + arrowLength / 3,
                 arrowStart.y - arrowLength / 3);
    display_Line(arrowStart.x + 1, arrowStart.y,
                 arrowStart.x + arrowLength / 3 + 1,
                 arrowStart.y - arrowLength / 3);
    display_Line(arrowStart.x, arrowStart.y + 1,
                 arrowStart.x + arrowLength / 3,
