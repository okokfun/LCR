...
namespace {
    ...
    struct pmf_cast<R(*)(F, A...), C, p> {
        static constexpr R(*cfn)(F t,
                                 A...a) = reinterpret_cast<R(*)(F t, A...a)>(p);

        static constexpr R(*toCfn())(F t, A...a) {
            return reinterpret_cast<R(*)(F t, A...a)>(p);
        }
    };

    template<class C, typename R, typename F, typename ...A, R(C::*p)(A...) const>
    struct pmf_cast<R(*const)(const F, A...), C, p> {
        static constexpr R(*cfn)(const F t,
                                 A...a) = reinterpret_cast<R(*)(const F t, A...a)>(p);

        static constexpr R(*toCfn())(const F t, A...a) {
            return reinterpret_cast<R(*)(const F t, A...a)>(p);
        }
    };
