...
class Window : public Widget {
  ...
  private:
    ...
    static constexpr color_t TitleForeground = COLOR(215, 214,
                                               207);
    static constexpr color_t CloseAreaBackground = COLOR(229, 99,
            42);
    static constexpr color_t CloseAreaForeground =
                    COLOR_BG_DEFAULT;
