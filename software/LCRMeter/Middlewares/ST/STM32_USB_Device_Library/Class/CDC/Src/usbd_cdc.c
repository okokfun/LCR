...
static uint8_t  USBD_CDC_EP0_RxReady(USBD_HandleTypeDef*
                                     pdev);
...
USBD_CDC_DeviceQualifierDesc[USB_LEN_DEV_QUALIFIER_DESC]
__ALIGN_END = {
...
static uint8_t  USBD_CDC_Init(USBD_HandleTypeDef* pdev,
    ...
    USBD_LL_OpenEP(pdev,
                   ...
                   USBD_EP_TYPE_INTR,
                   CDC_CMD_PACKET_SIZE);
    pdev->pClassData = USBD_malloc(sizeof(
...
* @brief  USBD_CDC_RegisterInterface
  ...
  * @retval status
  */
uint8_t  USBD_CDC_RegisterInterface(USBD_HandleTypeDef*
                                    pdev,
