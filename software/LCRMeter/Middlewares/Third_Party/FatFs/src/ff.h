...
extern PARTITION
VolToPart[];	/* Volume - Partition resolution table */
...
FRESULT f_lseek(FIL* fp,
                DWORD ofs);								/* Move file pointer of a file object */
...
FRESULT f_chdrive(const TCHAR*
                  path);								/* Change current drive */
FRESULT f_getcwd(TCHAR* buff,
                 UINT len);							/* Get current directory */
...
int f_putc(TCHAR c,
           FIL* fp);										/* Put a character to the file */
int f_puts(const TCHAR* str,
           FIL* cp);								/* Put a string to the file */
...
WCHAR ff_wtoupper(WCHAR
                  chr);			/* Unicode upper-case conversion */
...
int ff_cre_syncobj(BYTE vol,
                   _SYNC_t* sobj);	/* Create a sync object */
int ff_req_grant(_SYNC_t sobj);				/* Lock sync object */
void ff_rel_grant(_SYNC_t sobj);				/* Unlock sync object */
int ff_del_syncobj(_SYNC_t
                   sobj);				/* Delete a sync object */
#endif
